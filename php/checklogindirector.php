...
// }
 ...
 if (password_verify($password, $row['password'])) { 
    ...
    echo "<br><br><script> location.href='principaldirector.html'</script>"; //Te lleva al panel de control del usuario, panel que solo se muestra si se inicio sesión bien

 } else { 
   echo "Username o Password estan incorrectos.";

   echo "<br><script> location.href='logindirector.html'</script>"; //de vuelta al login para iniciar sesión si se hizo mal
 }
