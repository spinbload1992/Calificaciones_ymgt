...
//Si el usuario ya existe, pedir que se cree otro. 
 ...
 echo "<a href='registrodocente.html'>Por favor escoga otro Nombre de usuario</a>";
 } //Si el usuario NO existe entonces se crea y se agrega a la tabla usuarios con el usuario y password
 else{

 $query = "INSERT INTO docentes (nombre, password)
 ...
 echo "<h5>" . "Hacer Login: " . "<a href='logindocentes.html'>Login</a>" . "</h5>"; //Si el usuario se crea correctamente sale un mensaje para ir
